...
namespace ChonkyApp.Services
{
    public class DailyGoalDataStore
    {
        ...
        public static async Task<bool> InsertGoalEntry(DailyGoalEntry entry)
        {
        ...
        public static async Task<IEnumerable<DailyGoalEntry>> GetGoalEntriesForDay(DateTime day)
        {
        ...
        public static async Task<IEnumerable<DailyGoalEntry>> GetGoalEntriesOfTypeForDay(Guid id, DateTime day)
        {
        ...
        public static async Task<IEnumerable<DailyGoalEntry>> GetGoalEntries()
        {
            var items = SQLiteProvider.Database.Query<DailyGoalEntry>("SELECT * FROM DailyGoalEntry");
            return await Task.FromResult(items);
        }

        public static async Task<IEnumerable<DailyGoalEntry>> GetGoalEntriesOfType(Guid id)
        {
            var items = SQLiteProvider.Database.Query<DailyGoalEntry>("SELECT * FROM DailyGoalEntry WHERE ID = ?", id);
            return await Task.FromResult(items);
        }

        public static async Task<bool> DeleteGoalEntry(DailyGoalEntry goalEntry)
        {
